...
file buffers open in Insert mode, adds macOS Command shortcuts with Ctrl
fallbacks, and saves after 200 ms of inactivity. F12 temporarily switches to
normal Vim navigation. See
